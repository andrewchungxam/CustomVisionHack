...
namespace MyMobileApp.iOS {
	...
	/// </summary>
	public class mymodelInput : NSObject, IMLFeatureProvider
	{
	...
	/// </summary>
	public class mymodelOutput : NSObject, IMLFeatureProvider
	{
		static readonly NSSet<NSString> featureNames = new NSSet<NSString> (
		...
		public mymodelOutput (NSDictionary<NSObject, NSNumber> loss, string classLabel)
		{
			if (loss == null)
	...
	public class mymodel : NSObject
	{
		...
		mymodel (MLModel model)
		{
			this.model = model;
		}

		public static mymodel Create (NSUrl url, out NSError error)
		{
			if (url == null)
		...
		/// <param name="error">If an error occurs, upon return contains an NSError object that describes the problem.</param>
		public mymodelOutput GetPrediction (CVPixelBuffer data, out NSError error)
		{
			var input = new mymodelInput (data);
